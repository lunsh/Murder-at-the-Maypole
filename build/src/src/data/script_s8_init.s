...
.CURRENT_SCRIPT_BANK == ___bank_script_s8_init
...
_script_s8_init::
        ...
        ; Input Script Attach
        VM_CONTEXT_PREPARE      8, ___bank_script_input_9, _script_input_9
        VM_INPUT_ATTACH         1, ^/(8 | .OVERRIDE_DEFAULT)/

        VM_JUMP                 2$
1$:
        ; Input Script Attach
        VM_CONTEXT_PREPARE      4, ___bank_script_input_10, _script_input_10
        VM_INPUT_ATTACH         16, ^/(4 | .OVERRIDE_DEFAULT)/
...
2$:
        ...
        ; Input Script Attach
        VM_CONTEXT_PREPARE      7, ___bank_script_input_11, _script_input_11
