...
_script_s23_init::
        ...
        ; Input Script Attach
        VM_CONTEXT_PREPARE      3, ___bank_script_input_6, _script_input_6
        VM_INPUT_ATTACH         32, ^/(3 | .OVERRIDE_DEFAULT)/

        ; Input Script Attach
        VM_CONTEXT_PREPARE      6, ___bank_script_input_24, _script_input_24
        VM_INPUT_ATTACH         4, ^/(6 | .OVERRIDE_DEFAULT)/

        ; Input Script Attach
        VM_CONTEXT_PREPARE      4, ___bank_script_input_25, _script_input_25
